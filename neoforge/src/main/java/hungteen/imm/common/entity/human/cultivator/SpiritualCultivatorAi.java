...
public class SpiritualCultivatorAi {
     ...
     */
    public static void initCoreBehaviors(Brain<SpiritualBeginnerCultivator> brain, float speed) {
...
//                new StartAdmiringItemIfSeen<>(120)
     ...
     */
    public static void initIdleBehaviors(Brain<SpiritualBeginnerCultivator> brain, float speed) {
...
//                new StartFighting<>(EmptyCultivatorAi::findNearestValidAttackTarget),
     ...
     */
    public static void initMeleeFightBehaviors(Brain<SpiritualBeginnerCultivator> brain, float speed) {
...
//                Pair.of(1, new MeleeKeepDistance(speed)),
     ...
     */
    public static void initRangeFightBehaviors(Brain<SpiritualBeginnerCultivator> brain, float speed) {
...
//                Pair.of(1, new BackUpIfTooClose<>(64, speed)),
    ...
    protected static void wasHurtBy(SpiritualBeginnerCultivator cultivator, LivingEntity livingEntity) {
        Brain<SpiritualBeginnerCultivator> brain = cultivator.getBrain();
...
//            }
    ...
    private static void setAttackTarget(SpiritualBeginnerCultivator cultivator, LivingEntity livingEntity) {
        Brain<SpiritualBeginnerCultivator> brain = cultivator.getBrain();
    ...
    private static Optional<? extends LivingEntity> findNearestValidAttackTarget(SpiritualBeginnerCultivator cultivator) {
