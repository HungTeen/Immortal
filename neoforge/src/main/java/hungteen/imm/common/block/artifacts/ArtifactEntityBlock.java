 ...
 */
public abstract class ArtifactEntityBlock extends HTEntityBlock implements ArtifactBlock {

    private final ArtifactRank rank;

    protected ArtifactEntityBlock(BlockBehaviour.Properties properties, ArtifactRank rank) {
        super(properties);
        this.rank = rank;
    }
