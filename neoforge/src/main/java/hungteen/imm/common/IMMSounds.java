...
public interface IMMSounds {
    ...
    HTHolder<SoundEvent> CHILLAGER_IDLE = create("chillager_idle");
    HTHolder<SoundEvent> CHILLAGER_ATTACK = create("chillager_attack");
    HTHolder<SoundEvent> CHILLAGER_HURT = create("chillager_hurt");
    HTHolder<SoundEvent> CHILLAGER_DEATH = create("chillager_death");
