 ...
 **/
public class PlayerLikeArmorLayer<T extends PlayerLikeEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>> extends HumanoidArmorLayer<T, M, A> {

    private final boolean isSlim;

    public PlayerLikeArmorLayer(RenderLayerParent<T, M> layerParent, A innerModel, A outerModel, ModelManager manager, boolean isSlim) {
