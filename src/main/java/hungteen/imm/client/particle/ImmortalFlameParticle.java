 ...
 **/
public class ImmortalFlameParticle extends HTTextureParticle {

    /**
     * Copy From {@link net.minecraft.client.particle.RisingParticle}.
     */
    public ImmortalFlameParticle(ClientLevel clientLevel, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public record Factory(SpriteSet sprite) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z,
            ...
            ImmortalFlameParticle particle = new ImmortalFlameParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
