...
public class ReactionRenderer {
    ...
    private static void renderParticle(PoseStack stack, Camera camera, ReactionParticle particle) {
        ...
        RenderUtil.renderCenterScaledText(stack, particle.reaction.getComponent(), 0, 0, 5, ColorHelper.BLACK.rgb(), ColorHelper.BLACK.rgb());
    ...
    public static class ReactionParticle {
        ...
        public ReactionParticle(Entity entity, IElementReaction reaction) {
            ...
            this.speed = new Vec3(entity.level().getRandom().nextGaussian() * 0.1F, entity.level().getRandom().nextGaussian() * 0.1F, entity.level().getRandom().nextGaussian() * 0.1F);
        }
        ...
        public void tick() {
            ...
            this.speed = this.speed.scale(0.98F);
        }
