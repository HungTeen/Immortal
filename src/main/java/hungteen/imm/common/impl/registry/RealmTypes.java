...
public class RealmTypes {
    ...
    public static final IRealmType MONSTER_LEVEL_1 = register(new RealmType("monster_level_1", 50, 120, 60, 75, CultivationTypes.MONSTER));

    public static final IRealmType MONSTER_LEVEL_2 = register(new RealmType("monster_level_2", 120, 225, 80, 100, CultivationTypes.MONSTER));

    public static final IRealmType MONSTER_LEVEL_3 = register(new RealmType("monster_level_3", 240, 325, 100, 125, CultivationTypes.MONSTER));
    ...
    public static final IRealmType UNDEAD_LEVEL_3 = register(new RealmType("undead_level_3", 400, 520, 175, 250, CultivationTypes.UNDEAD));
