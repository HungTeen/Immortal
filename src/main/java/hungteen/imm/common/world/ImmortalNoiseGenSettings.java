...
import hungteen.imm.common.world.dimension.SpiritualLandDimension;
...
public class ImmortalNoiseGenSettings {
    ...
    public static final DeferredRegister<NoiseGeneratorSettings> NOISE_GENERATOR_SETTINGS = DeferredRegister.create(Registries.NOISE_SETTINGS, Util.id());
