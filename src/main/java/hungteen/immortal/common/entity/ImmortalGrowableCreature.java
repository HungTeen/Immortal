 ...
 **/
public abstract class ImmortalGrowableCreature extends ImmortalCreature {

    private static final EntityDataAccessor<Integer> AGE = SynchedEntityData.defineId(ImmortalGrowableCreature.class, EntityDataSerializers.INT);
    protected int growTick = 0;
    protected int forcedAgeTimer;

    public ImmortalGrowableCreature(EntityType<? extends ImmortalGrowableCreature> type, Level level) {
        super(type, level);
    }
